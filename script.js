...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const roles = ["Frontend Developer.", "Graphic Designer.", "ICT Support."];
...
// PTf BUTTON
// ==============================
const ptfBtn = document.getElementById("ptfBtn");

if (ptfBtn) {
    ptfBtn.addEventListener("click", () => {
        console.log("Portfolio button clicked ✅");
        window.open(
            "docs/Christopher Oyuga Portfolio.pdf",
            "_blank",
            "noopener,noreferrer"
        );
    });
...
if (cvBtn) {
    cvBtn.addEventListener("click", () => {
        ...
        window.open(
            "docs/Christopher Oyuga CV 1.pdf",
            "_blank",
            "noopener,noreferrer"
        );
    });
